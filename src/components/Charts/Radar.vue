            ...
            <vgg-map v-slot="{ row, i }">
              ...
              > -->
                ...
                <vgg-map
                  ...
                  <vgg-multi-line
                    :x="dimensions"
                    :y="[dataframe.scaledPrice[i], dataframe.scaledWW[i], dataframe.scaledHP[i]]"
                    :stroke="'black'"
                    :close="true"
                    :fill-opacity="0.4"
                    :fill="row.Color"
                  ...
                  <!-- <vgg-multi-line
                    :x="dimensions"
                    :y="[dataframe.scaledPrice[i], dataframe.scaledWW[i], dataframe.scaledHP[i], dataframe.scaledSpeed,[i], dataframe.scaledMiles[i], dataframe.scaledZero60[i], dataframe.scaledStop60[i], dataframe.scaledRwtq[i], dataframe.scaledQuartersec[i], dataframe.scaledPwr[i]]"
                    :stroke="'black'"
                    :close="true"
                    :fill-opacity="0.4"
                    :fill="row.Color"
