<template>
  <vgg-graphic :width="800" :height="850" :data="resaleData">
    ...
    <vgg-data
      :transform="[
        { binning: { groupBy: 'resale_price', method: 'EqualInterval', numClasses: 5 } },
        { summarise: { binCount: { resale_price: 'count' } } }
      ]"
    >
      <vgg-section
        :x1="500"
        ...
        :y1="100"
        :y2="400"
        :scale-x="{ domain: 'binCount', domainMin: 0 }"
        :scale-y="'bins'"
      >
    ...
    <!-- green -->
    <vgg-section :x1="100" :x2="400" :y1="500" :y2="800" :scale-x="[0, 1]" :scale-y="[0, 1]">
      <vgg-rectangle :y1="0" :y2="1" :x1="0" :x2="1" fill="green"/>
    </vgg-section>
...
export default {
  ...
  mounted () {
    for (let i in this.resaleData) {
      if (resaleData[i].resale.constructor !== Number) {
